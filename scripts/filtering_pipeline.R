...
input_norm = cpm(GSE125583_Symbol)

## calculating normalized global mean
global_mean <- mean(as.matrix(input_norm))
...
## change input_data and output data file name to match group data